...
link4.setAttribute("href","./update_session.html?name="+ sessionsitems[i].person_name);
detail.append(link4);
...
link2.setAttribute("href","./update_session.html?name="+ sessionsitems[i].person_name);
...
link3.setAttribute("href","./update_session.html?name="+ sessionsitems[i].person_name)
