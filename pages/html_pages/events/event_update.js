...
let delete_event = document.getElementById("turn_off");
let update_event = document.getElementById("update_event");
  ...
  function update_event_fun() {
    for (let i = 0; i < a.length; i++) {
      if (update_event_value==a[i].event_id) {
          ...
          a[i].para=document.getElementById("about_event_line").value;
          a[i].about=document.getElementById("eventBriefParagraph ").value;
